...
\label{tab:robots}
\centering
% TODO fill the Movilo slope tolerance and the FT-P320 step, slope, and
% drive type; Movilo values from the project report (height loaded with
% goods); GO2 standing dimensions and tolerances from the official Unitree
% specifications
...
Maximum climbable step ($s_{\max}$) & 0.045\,m & 0.16\,m & x \\
Maximum climbable slope ($\theta_{\max}$) & x & $40^{\circ}$ & x \\
