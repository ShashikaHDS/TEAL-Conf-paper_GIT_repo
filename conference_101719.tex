...
\subfloat[]{\includegraphics[width=0.31\textwidth]{figs/setting2_predicted.png}}\hfil
\subfloat[]{\includegraphics[width=0.31\textwidth]{figs/setting2_annotated.png}}\hfil
\subfloat[]{\includegraphics[width=0.31\textwidth]{figs/setting2_difference.png}}\\
\subfloat[]{\includegraphics[width=0.31\textwidth]{figs/setting3_predicted.png}}\hfil
\subfloat[]{\includegraphics[width=0.31\textwidth]{figs/setting3_annotated.png}}\hfil
\subfloat[]{\includegraphics[width=0.31\textwidth]{figs/setting3_difference.png}}
\caption{Predicted accessibility heat maps compared with the maps annotated from observed robot behaviour for the settings assessed with the Movilo. Rows from top to bottom are Setting~1 (a)--(c), Setting~2 (d)--(f), and Setting~3 (g)--(i); the columns show the predicted map, the map annotated from the deployment video, and their disagreement. Green marks area the robot can reach, orange marks required area it cannot, and the disagreement panels colour every pixel on which the two maps differ in red.}
...
\subfloat[]{\includegraphics[width=0.31\textwidth]{figs/setting5_predicted.png}}\hfil
\subfloat[]{\includegraphics[width=0.31\textwidth]{figs/setting5_annotated.png}}\hfil
\subfloat[]{\includegraphics[width=0.31\textwidth]{figs/setting5_difference.png}}
\caption{Predicted, annotated, and disagreement maps as in Fig.~\ref{fig:heatmaps_movilo}, for the settings assessed with the GO2. Rows from top to bottom are Setting~4 (a)--(c) and Setting~5 (d)--(f). Disagreement concentrates in a thin halo at the region boundaries rather than in the interior.}
