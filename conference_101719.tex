...
\label{sec:setup}
We validated the framework at the New Science Centre construction site in Singapore, an active project whose cluttered and changing conditions match the environments the method targets. Five environment settings were selected across the site, and each setting stages one or more of the validation test cases of Section~\ref{sec:testcases}. Table~\ref{tab:settings} lists the staged cases and the conditions in which each was set up, following the two-condition design of the protocol. Table~\ref{tab:settingdetail} lists the platform, zone, and representative staged items of each setting. Setting~3 ran a reduced set because several planned test items were unavailable on the day, an ordinary constraint of working on an active site, and Setting~5 additionally recorded conditions found on site rather than staged.

\begin{table}[t]
\caption{Environment settings: platform assessed, zone, and representative staged and encountered items.}
\label{tab:settingdetail}
\centering
\footnotesize
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{@{}cclp{4.6cm}@{}}
\toprule
Setting & Zone & Robot & Staged and encountered items \\
\midrule
1 & 3 & Movilo & Corridor widths, safety cones, temporary partitions, material stacks, large materials \\
2 & 2 & Movilo & Floor obstacles including consumables, wood offcuts, rebar, and a toolbox, narrow gaps, floor depressions \\
3 & 3 & Movilo & Reduced set of four conditions with tight lateral clearances and a portable bump \\
4 & 2 & GO2 & Corridor conditions with small floor obstacles, a hump, a plank, a hand tool, and a pallet \\
5 & 4 & GO2 & Corridor height, wet floor, ramps of five and six degrees, a step fitted with a plywood ramp, protruding rebars, a parked aerial work machine, a light tower \\
\bottomrule
\end{tabular}
\end{table}
