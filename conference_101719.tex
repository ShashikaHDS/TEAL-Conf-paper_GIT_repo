...
The comparisons follow a consistent pattern. Obstacles placed at the edge of a route were correctly left accessible, passages narrower than the inflated footprint and blocking partitions were correctly marked unreachable, and the indices separated the two platforms in the order their capabilities predict. % TODO confirm these qualitative observations against the final annotation set
